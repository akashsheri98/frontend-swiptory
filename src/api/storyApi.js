...
export const createStory = (values) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.post(`${backendUrl}/story/create`, values ,{
        headers: {
  ...
  export const getStories = (page, catLimit, cat) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(
        `${backendUrl}/story/getAll?category=All&page=${page}&catLimit=${catLimit}&cat=${cat}`
      );
      console.log(data);
  ...
  export const getStory = (storyId, userId) => async (dispatch) => {
    try {
      ...
      if (userId == null) {
        ...
        const { data } = await axios.get(`${backendUrl}/story/getById/${storyId}`);
  ...
  export const getStoriesByUser =
    (userId, userStoriesPage) => async (dispatch) => {
      try {
        ...
        const { data } = await axios.get(
          `${backendUrl}/story/getAll?userId=${userId}&page=${userStoriesPage}`
        );
    ...
    export const getStoriesByCategory = (category, page) => async (dispatch) => {
        try {
          ...
          const { data } = await axios.get(
            `${backendUrl}/story/getAll?category=${category}&page=${page}`
          );
      ...
      export const likeStory = (id, userId) => async (dispatch) => {
        try {
          ...
          const data = await axios.put(`${backendUrl}/story/like/${id}`, { userId: userId },{
            headers: {
              Authorization: `Bearer ${token}`,
            },
          });
      ...
      export const getBookmarks = (userId) => async (dispatch) => {
        try {
          ...
          const { data } = await axios.get(`${backendUrl}/user/bookmarks/${userId}`,{
            headers: {
              Authorization: `Bearer ${token}`,
            },
          });
      ...
      export const bookmarkStory = (id, userId) => async (dispatch) => {
        try {
          ...
          const { data } = await axios.post(`${backendUrl}/user/bookmark/${id}`, {
            userId: userId,
          },{
            headers: {
              Authorization: `Bearer ${token}`,
