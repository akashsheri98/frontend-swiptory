...
import { editStorySuccess } from "../../../redux/storySlice";
  ...
  const token = Cookies.get("token") || localStorage.getItem("token");
    ...
    try {
      ...
      const response = await axios
        .put(`${BackendUrl}/story/update/${story._id}`, {
          slides,
          addedBy: user,
        },{
          headers: {
...
//   useEffect(() => {
//     setCurrentSlide(0); // Reset current slide index whenever story changes
//   }, [story]);
...
//         `${import.meta.env.VITE_REACT_APP_BACKEND_URL}/api/story/update/${story._id}`,
//         {
//           slides,
//           addedBy: user,
//         }
...
//           text="Update"
//           size="small"
//           disabled={slides.length < 3 || slides.length > 6}
//         />
//       </div>
//     </div>
//   );
